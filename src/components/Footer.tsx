            ...
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">
                  Hno: Piispantie 5 G, 00370, Helsinki, Finland
                </address>
                <a
                  href="tel:+358 4344 6000"
                  className="mt-3 d-block mb-2 text-white"
                >
                  +358 4344 6000
                </a>
                <a
                  href="mailto:hainguyenn257@gmail.com"
                  className="mt-3 d-block mb-2 text-white"
                >
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}: All right reserve By Pepsi
              </p>
            </div>
          </div>
        </div>
